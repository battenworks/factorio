...
local view_name = "bwbd_fluid_station_view"
local selection_button_name = "bwbd_fluid_station_selection_button"
local direction_switch_name = "bwbd_fluid_station_direction_switch"
