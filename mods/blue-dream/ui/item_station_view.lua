...
local view_name = "bwbd_item_station_view"
local selection_button_name = "bwbd_item_station_view_selection_button"
local direction_switch_name = "bwbd_item_station_view_direction_switch"
